  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">智慧消防微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.louhao" class="input" type="text" placeholder="楼号">
			   </div>
			 </div> -->
			<el-form-item label="楼号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.louhao" autocomplete="off" placeholder="楼号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="门牌号" class="input" v-if="tableName=='yonghu'">
