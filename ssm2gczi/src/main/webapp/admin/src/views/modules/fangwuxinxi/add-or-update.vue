<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房型" prop="fangxing">
          <el-input v-model="ruleForm.fangxing" 
              placeholder="房型" clearable  :readonly="ro.fangxing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房型" prop="fangxing">
              <el-input v-model="ruleForm.fangxing" 
