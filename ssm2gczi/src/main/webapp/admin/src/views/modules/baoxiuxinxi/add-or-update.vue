  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baoxiushijian" label="报修时间" prop="baoxiushijian">
              <el-input v-model="ruleForm.baoxiushijian" 
                placeholder="报修时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="报修状态" prop="baoxiuzhuangtai">
          <el-select v-model="ruleForm.baoxiuzhuangtai" placeholder="请选择报修状态">
            <el-option
                v-for="(item,index) in baoxiuzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="报修状态" prop="baoxiuzhuangtai">
	      <el-input v-model="ruleForm.baoxiuzhuangtai"
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.menpaihao!=''&&json.menpaihao){
